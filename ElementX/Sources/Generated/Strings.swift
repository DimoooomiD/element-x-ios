...
internal enum L10n {
  ...
  /// Settings
  internal static var screenHomeTabSettings: String { return L10n.tr("Localizable", "screen_home_tab_settings") }
  /// Spaces
  ...
  /// Welcome to Lingugram. Your personal language learning companion for mastering new languages.
