...
// Note: The primitive style is needed to set the list row insets to `0`.
...
// Note: The previews demonstrate the button style usage.
// The style works with ListRow components that expand to fill available space.
