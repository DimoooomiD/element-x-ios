...
struct LibraryScreenViewState: BindableState {
    var languagePackages: [LanguageLearningPackage] = [
        LanguageLearningPackage(id: "spanish-basics",
                                ...
                                level: "Beginner",
                                icon: "🇪🇸"),
        LanguageLearningPackage(id: "french-intermediate",
                                ...
                                level: "Intermediate",
                                icon: "🇫🇷"),
        LanguageLearningPackage(id: "german-complete",
                                ...
                                level: "All Levels",
                                icon: "🇩🇪"),
        LanguageLearningPackage(id: "japanese-basics",
                                ...
                                level: "Beginner",
                                icon: "🇯🇵"),
        LanguageLearningPackage(id: "italian-conversation",
