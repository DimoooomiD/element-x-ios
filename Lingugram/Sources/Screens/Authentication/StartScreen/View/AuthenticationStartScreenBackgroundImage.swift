...
struct AuthenticationStartScreenBackgroundImage: View {
    ...
    var body: some View {
        ZStack {
            ...
            LinearGradient(colors: baseGradientColors,
            ...
            GeometryReader { geometry in
                ...
                Circle()
                    ...
                    .offset(x: animateGradient ? geometry.size.width * 0.3 : geometry.size.width * 0.1,
                ...
                Circle()
                    ...
                    .offset(x: animateGradient ? geometry.size.width * 0.7 : geometry.size.width * 0.5,
                ...
                ForEach(0..<3, id: \.self) { index in
                    Circle()
                        ...
                        .blur(radius: 30)
                        .animation(Animation.easeInOut(duration: Double(8 + index * 2))
                            .repeatForever(autoreverses: true)
